...
fname_train_acc = f'Results/MSE_DataReuploading/train_acc_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_MSEDR.txt'
...
fname_test_acc = f'Results/MSE_DataReuploading/test_acc_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_MSEDR.txt'
...
fname_train_cost = f'Results/MSE_DataReuploading/train_cost_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_MSEDR.txt'
...
fname_test_cost = f'Results/MSE_DataReuploading/test_cost_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_MSEDR.txt'
