...
def data_encoding(features):
    qml.AmplitudeEmbedding(features,wires=range(3), normalize=True) 
...
fname_train_acc = f'Results/Cross_Entropy/train_acc_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_{seed}seed_CrossEntropy.txt'
...
fname_test_acc = f'Results/Cross_Entropy/test_acc_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_{seed}seed_CrossEntropy.txt'
...
fname_train_cost = f'Results/Cross_Entropy/train_cost_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_{seed}seed_CrossEntropy.txt'
...
fname_test_cost = f'Results/Cross_Entropy/test_cost_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_{seed}seed_CrossEntropy.txt'
