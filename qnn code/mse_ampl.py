...
fname_train_acc = f'Results/MSE/train_acc_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_{seed}seed_MSE.txt'
...
fname_test_acc = f'Results/MSE/test_acc_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_{seed}seed_MSE.txt'
...
fname_train_cost = f'Results/MSE/train_cost_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_{seed}seed_MSE.txt'
...
fname_test_cost = f'Results/MSE/test_cost_{layers}layers_lerningrate{lr}_batchsize{batch_size}_stocstep{stocastic_step}_{epochs}epochs_{seed}seed_MSE.txt'
