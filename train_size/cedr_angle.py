...
np.random.seed(seed)
train_size = int(X_train_all.shape[0]*t_size)
random_train = np.random.permutation(X_train_all.shape[0])[:train_size]
...
#X_train = jnp.array(X_new)
#X_test = jnp.array(X_test)
#Y_train = jnp.array(Y_new)
#Y_test = jnp.array(Y_test)
...
fname_train_acc = f'Results/Cross_Entropy_DataReuploading/train_acc_{layers}layers_batchsize{batch_size}_stocstep{stocastic_step}_{seed}seed_{t_size}trainsize_CE_4.txt'
...
fname_test_acc = f'Results/Cross_Entropy_DataReuploading/test_acc_{layers}layers_batchsize{batch_size}_stocstep{stocastic_step}_{seed}seed_{t_size}trainsize_CE_4.txt'
...
fname_train_cost = f'Results/Cross_Entropy_DataReuploading/train_cost_{layers}layers_batchsize{batch_size}_stocstep{stocastic_step}_{seed}seed_{t_size}trainsize_CE_4.txt'
...
fname_test_cost = f'Results/Cross_Entropy_DataReuploading/test_cost_{layers}layers_batchsize{batch_size}_stocstep{stocastic_step}_{seed}seed_{t_size}trainsize_CE_4.txt'
